require=function t(e,n,i){function r(a,s){if(!n[a]){if(!e[a]){var u="function"==typeof require&&require;if(!s&&u)return u(a,!0);if(o)return o(a,!0);var c=new Error("Cannot find module '"+a+"'");throw c.code="MODULE_NOT_FOUND",c}var p=n[a]={exports:{}};e[a][0].call(p.exports,function(t){var n=e[a][1][t];return r(n?n:t)},p,p.exports,t,e,n,i)}return n[a].exports}for(var o="function"==typeof require&&require,a=0;a<i.length;a++)r(i[a]);return r}({1:[function(t,e,n){var i=t("../internal/app"),r=t("../util/rectangle"),o=t("../system/audio"),a=t("../internal/util/json"),s=t("../internal/util/xml"),u=t("./transition"),c=5,p=1e3,m=function(){function t(){}return t.prototype.getFrametime=function(){return new Promise(function(t){i.App.get("frametime").then(function(e){t(Number(e))})})},t.prototype.getResolution=function(){return new Promise(function(t){i.App.get("resolution").then(function(e){var n=e.split(",");t(r.Rectangle.fromDimensions(parseInt(n[0]),parseInt(n[1])))})})},t.prototype.getViewport=function(){return new Promise(function(t){i.App.get("viewport").then(function(e){var n=e.split(",");t(r.Rectangle.fromDimensions(parseInt(n[0]),parseInt(n[1])))})})},t.prototype.getVersion=function(){return new Promise(function(t){t(i.App.get("version"))})},t.prototype.getFramesRendered=function(){return new Promise(function(t){i.App.get("framesrendered").then(function(e){t(Number(e))})})},t.prototype.getPrimaryMic=function(){return new Promise(function(t){i.App.getAsList("microphonedev2").then(function(e){var n=e.map(function(t){return o.AudioDevice.parse(t)});t(n.length&&n.length>0?n[0]:new o.AudioDevice({id:"empty"}))})})},t.prototype.getPrimarySpeaker=function(){return new Promise(function(t){i.App.getAsList("microphonedev2").then(function(e){var n=e.map(function(t){return o.AudioDevice.parse(t)});t(n.length&&n.length>1?n[1]:new o.AudioDevice({id:"empty"}))})})},t.prototype.setPrimaryMic=function(t){return new Promise(function(e){i.App.getAsList("microphonedev2").then(function(n){var r=n.map(function(t){return o.AudioDevice.parse(t)});r[0]=t;var a="";if(Array.isArray(r))for(var s=0;s<r.length;++s)a+=r[s].toString();a="<devices>"+a+"</devices>",i.App.set("microphonedev2",a).then(function(t){e(t)})})})},t.prototype.setPrimarySpeaker=function(t){return new Promise(function(e){i.App.getAsList("microphonedev2").then(function(n){var r=n.map(function(t){return o.AudioDevice.parse(t)});r[1]=t;var a="";if(Array.isArray(r))for(var s=0;s<r.length;++s)a+=r[s].toString();a="<devices>"+a+"</devices>",i.App.set("microphonedev2",a).then(function(t){e(t)})})})},t.prototype.isSilenceDetectionEnabled=function(){return new Promise(function(t){i.App.get("microphonegain").then(function(e){var n=a.JSON.parse(e);t("1"==n.enable)})})},t.prototype.enableSilenceDetection=function(t){return new Promise(function(e){i.App.get("microphonegain").then(function(n){var r=a.JSON.parse(decodeURIComponent(n));r.enable=t?"1":"0",i.App.set("microphonegain",s.XML.parseJSON(r).toString()).then(function(t){e(t)})})})},t.prototype.getSilenceDetectionPeriod=function(){return new Promise(function(t){i.App.get("microphonegain").then(function(e){var n=a.JSON.parse(e);t(void 0!==n.latency?Number(n.latency):p)})})},t.prototype.setSilenceDetectionPeriod=function(t){return new Promise(function(e,n){"number"!=typeof t?n(Error("Silence detection period must be a number")):t%1!=0?n(Error("Silence detection period must be an integer")):(0>t||t>6e4)&&n(Error("Silence detection must be in the range 0-60000.")),i.App.get("microphonegain").then(function(n){var r=a.JSON.parse(decodeURIComponent(n));r.latency=t.toString(),i.App.set("microphonegain",s.XML.parseJSON(r).toString()).then(function(t){e(t)})})})},t.prototype.getSilenceDetectionThreshold=function(){return new Promise(function(t){i.App.get("microphonegain").then(function(e){var n=a.JSON.parse(e);t(void 0!==n.gain?Number(n.gain):c)})})},t.prototype.setSilenceDetectionThreshold=function(t){return new Promise(function(e,n){"number"!=typeof t?n(Error("Silence detection threshold must be a number")):t%1!=0?n(Error("Silence detection threshold must be an integer")):(0>t||t>128)&&n(Error("Silence detection threshold must be in the range 0-128.")),i.App.get("microphonegain").then(function(n){var r=a.JSON.parse(decodeURIComponent(n));r.gain=t.toString(),i.App.set("microphonegain",s.XML.parseJSON(r).toString()).then(function(t){e(t)})})})},t.prototype.getTransition=function(){return new Promise(function(t){i.App.get("transitionid").then(function(e){t(""===e?u.Transition.NONE:u.Transition[e.toUpperCase()])})})},t.prototype.setTransition=function(t){return new Promise(function(e){i.App.set("transitionid",t.toString()).then(function(t){e(t)})})},t.prototype.getTransitionTime=function(){return new Promise(function(t){i.App.get("transitiontime").then(function(e){t(Number(e))})})},t.prototype.setTransitionTime=function(t){return new Promise(function(e){i.App.set("transitiontime",t.toString()).then(function(t){e(t)})})},t}();n.App=m},{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24,"../system/audio":25,"../util/rectangle":34,"./transition":16}],2:[function(t,e,n){var i=t("../internal/app"),r=function(){function t(t){this._name=t.name,this._stat=t.stat,this._channel=t.channel}return t.getActiveStreamChannels=function(){return new Promise(function(e){i.App.getAsList("recstat").then(function(n){if(0===n.length)e([]);else{for(var i=[],r=0;r<n.length;++r)i.push(new t({name:n[r].name,stat:n[r].children[0],channel:n[r].children[1]}));e(i)}})})},t.prototype.getName=function(){var t=this;return new Promise(function(e){e(t._name)})},t.prototype.getStreamDrops=function(){var t=this;return new Promise(function(e){i.App.get("streamdrops:"+t._name).then(function(t){var n=t.split(","),i=Number(n[0])||0;e(i)})})},t.prototype.getStreamRenderedFrames=function(){var t=this;return new Promise(function(e){i.App.get("streamdrops:"+t._name).then(function(t){var n=t.split(","),i=Number(n[1])||0;e(i)})})},t.prototype.getStreamTime=function(){var t=this;return new Promise(function(e){i.App.get("streamtime:"+t._name).then(function(t){var n=Number(t)/10;e(n)})})},t}();n.Channel=r},{"../internal/app":17}],3:[function(t,e,n){var i=function(){function t(){}return t.initialize=function(){t._initialized||(t._isSourcePlugin=window.external&&void 0!==window.external.GetConfiguration,t._isSourceConfig=window.external&&void 0===window.external.GetConfiguration&&void 0!==window.external.GetViewId&&void 0!==window.external.GetViewId(),t._isExtension=window.external&&void 0===window.external.GetConfiguration&&void 0!==window.external.GetViewId&&void 0===window.external.GetViewId(),t._initialized=!0)},t.isSourcePlugin=function(){return t._isSourcePlugin},t.isSourceConfig=function(){return t._isSourceConfig},t.isExtension=function(){return t._isExtension},t}();n.Environment=i,i.initialize()},{}],4:[function(t,e,n){var i=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},r=t("../../internal/util/mixin"),o=t("../../internal/item"),a=t("./iaudio"),s=t("./item"),u=t("../environment"),c=function(t){function e(){t.apply(this,arguments)}return i(e,t),e.prototype.isSilenceDetectionEnabled=function(){var t=this;return new Promise(function(e){var n=o.Item.attach(t._id);o.Item.get("prop:AudioGainEnable",n).then(function(t){e("1"===t)})})},e.prototype.setSilenceDetectionEnabled=function(t){var e=this;return new Promise(function(n,i){if(u.Environment.isSourcePlugin())i(Error("Source plugins cannot update audio sources properties"));else{var r=o.Item.attach(e._id);o.Item.set("prop:AudioGainEnable",t?"1":"0",r).then(function(t){t?n(e):i(Error("Item set property failed"))})}})},e.prototype.getSilenceThreshold=function(){var t=this;return new Promise(function(e){var n=o.Item.attach(t._id);o.Item.get("prop:AudioGain",n).then(function(t){e(Number(t))})})},e.prototype.setSilenceThreshold=function(t){var e=this;return new Promise(function(n,i){if(u.Environment.isSourcePlugin())i(Error("Source plugins cannot update audio sources properties"));else if("number"!=typeof t)i(Error("Only numbers are acceptable values for threshold"));else if(t%1!==0||0>t||t>128)i(Error("Only integers in the range 0-128 are acceptable for threshold"));else{var r=o.Item.attach(e._id);o.Item.set("prop:AudioGain",String(t),r).then(function(t){t?n(e):i(Error("Item set property failed"))})}})},e.prototype.getSilencePeriod=function(){var t=this;return new Promise(function(e){var n=o.Item.attach(t._id);o.Item.get("prop:AudioGainLatency",n).then(function(t){e(Number(t))})})},e.prototype.setSilencePeriod=function(t){var e=this;return new Promise(function(n,i){if(u.Environment.isSourcePlugin())i(Error("Source plugins cannot update audio sources properties"));else if("number"!=typeof t)i(Error("Only numbers are acceptable values for period"));else if(t%1!==0||0>t||t>1e4)i(Error("Only integers in the range 0-10000 are acceptable for period"));else{var r=o.Item.attach(e._id);o.Item.set("prop:AudioGainLatency",String(t),r).then(function(t){t?n(e):i(Error("Item set property failed"))})}})},e}(s.Item);n.AudioItem=c,r.applyMixins(s.Item,[a.ItemAudio])},{"../../internal/item":21,"../../internal/util/mixin":23,"../environment":3,"./iaudio":8,"./item":13}],5:[function(t,e,n){var i=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},r=t("../../internal/util/mixin"),o=t("../../internal/item"),a=t("./ilayout"),s=t("./icolor"),u=t("./ichroma"),c=t("./itransition"),p=t("./item"),m=function(t){function e(){t.apply(this,arguments)}return i(e,t),e.prototype.getDeviceId=function(){var t=this;return new Promise(function(e){var n=o.Item.attach(t._id);o.Item.get("prop:item",n).then(function(t){e(t)})})},e.prototype.setColorOptionsPinned=function(t){var e=this;return new Promise(function(n){var i=o.Item.attach(e._id);o.Item.set("prop:cc_pin",t?"1":"0",i).then(function(){n(e)})})},e.prototype.getColorOptionsPinned=function(){var t=this;return new Promise(function(e){var n=o.Item.attach(t._id);o.Item.get("prop:cc_pin",n).then(function(t){e("1"===t?!0:!1)})})},e.prototype.setKeyingOptionsPinned=function(t){var e=this;return new Promise(function(n){var i=o.Item.attach(e._id);o.Item.set("prop:key_pin",t?"1":"0",i).then(function(){n(e)})})},e.prototype.getKeyingOptionsPinned=function(){var t=this;return new Promise(function(e){var n=o.Item.attach(t._id);o.Item.get("prop:key_pin",n).then(function(t){e("1"===t?!0:!1)})})},e}(p.Item);n.CameraItem=m,r.applyMixins(m,[a.ItemLayout,s.ItemColor,u.ItemChroma,c.ItemTransition])},{"../../internal/item":21,"../../internal/util/mixin":23,"./ichroma":9,"./icolor":10,"./ilayout":12,"./item":13,"./itransition":14}],6:[function(t,e,n){var i=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},r=t("../../internal/util/mixin"),o=t("../../internal/item"),a=t("./ilayout"),s=t("./icolor"),u=t("./ichroma"),c=t("./itransition"),p=t("./item"),m=t("../../internal/util/json"),l=t("../../internal/util/xml"),h=t("./item"),f=t("../environment"),d=function(t){function e(){t.apply(this,arguments)}return i(e,t),e.prototype.isSpecialOptimizationEnabled=function(){var t=this;return new Promise(function(e){o.Item.attach(t._id);o.Item.get("GameCapSurfSharing").then(function(t){e("1"===t)})})},e.prototype.setSpecialOptimizationEnabled=function(t){var e=this;return new Promise(function(n){var i=o.Item.attach(e._id);o.Item.set("GameCapSurfSharing",t?"1":"0",i).then(function(){n(e)})})},e.prototype.isShowMouseEnabled=function(){var t=this;return new Promise(function(e){o.Item.attach(t._id);o.Item.get("GameCapShowMouse").then(function(t){e("1"===t)})})},e.prototype.setShowMouseEnabled=function(t){var e=this;return new Promise(function(n){var i=o.Item.attach(e._id);o.Item.set("GameCapShowMouse",t?"1":"0",i).then(function(){n(e)})})},e.prototype.setOfflineImage=function(t){var e=this;return new Promise(function(n,i){if(e._type!==h.ItemTypes.GAMESOURCE)i(Error("Current item should be a game source"));else if(f.Environment.isSourcePlugin())i(Error("Source plugins cannot update offline images of other sources"));else if(e._value instanceof l.XML){var r=new RegExp('^(([A-Z|a-z]:\\\\[^*|"<>?\n]*)|(\\\\\\\\.*?\\\\.*)|([A-Za-z]+\\\\[^*|"<>?\\n]*)).(png|gif|jpg|jpeg|tif)$');if(r.test(t)||""===t){var o=m.JSON.parse(e._value.toString());o.replace=t,e.setValue(l.XML.parseJSON(o)).then(function(){n(e)})}}else e.getValue().then(function(){e.setOfflineImage(t).then(function(t){n(t)})})})},e.prototype.getOfflineImage=function(){var t=this;return new Promise(function(e,n){t._type!==h.ItemTypes.GAMESOURCE?n(Error("Current item should be a game source")):t.getValue().then(function(){var n=m.JSON.parse(t._value.toString());e(n.replace?n.replace:"")})})},e}(p.Item);n.GameItem=d,r.applyMixins(d,[a.ItemLayout,s.ItemColor,u.ItemChroma,c.ItemTransition])},{"../../internal/item":21,"../../internal/util/json":22,"../../internal/util/mixin":23,"../../internal/util/xml":24,"../environment":3,"./ichroma":9,"./icolor":10,"./ilayout":12,"./item":13,"./itransition":14}],7:[function(require,module,exports){var __extends=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},internal_1=require("../../internal/internal"),mixin_1=require("../../internal/util/mixin"),item_1=require("../../internal/item"),ilayout_1=require("./ilayout"),icolor_1=require("./icolor"),ichroma_1=require("./ichroma"),itransition_1=require("./itransition"),iconfig_1=require("./iconfig"),item_2=require("./item"),rectangle_1=require("../../util/rectangle"),environment_1=require("../environment"),HTMLItem=function(_super){function HTMLItem(){_super.apply(this,arguments)}return __extends(HTMLItem,_super),HTMLItem.prototype.getURL=function(){var t=this;return new Promise(function(e){var n=item_1.Item.attach(t._id);item_1.Item.get("prop:item",n).then(function(t){var n=String(t).split("*");t=n[0],e(t)})})},HTMLItem.prototype.setURL=function(t){var e=this;return new Promise(function(n,i){var r=item_1.Item.attach(e._id);item_1.Item.set("prop:item",t,r).then(function(t){t?n(e):i("Invalid value")})})},HTMLItem.prototype.getBrowserJS=function(){var t=this;return new Promise(function(e){var n=item_1.Item.attach(t._id);item_1.Item.get("prop:custom",n).then(function(t){var n="";try{var i=JSON.parse(t);i.hasOwnProperty("customJS")&&(n=i.customJS)}catch(r){}e(n)})})},HTMLItem.prototype.setBrowserJS=function(t,e){var n=this;return void 0===e&&(e=!1),new Promise(function(i,r){var o=item_1.Item.attach(n._id),a={};item_1.Item.get("prop:custom",o).then(function(e){var n="",i=" ",r=!0,s=!0;try{a=JSON.parse(e),a.hasOwnProperty("cssEnabled")&&(s="true"==a.cssEnabled),a.hasOwnProperty("scriptEnabled")&&(r="true"==a.scriptEnabled),a.hasOwnProperty("customCSS")&&(n=a.customCSS)}catch(u){}if(a.cssEnabled=s.toString(),a.scriptEnabled=r.toString(),a.customCSS=n,a.customJS=t,s===!0){var c="var xjsCSSOverwrite = document.createElement('style');xjsCSSOverwrite.id = 'splitmedialabsCSSOverwrite';xjsCSSOverwrite.type = 'text/css';var h = document.querySelector('head');var existing = document.querySelector('head #splitmedialabsCSSOverwrite');if (existing != null)h.removeChild(existing);xjsCSSOverwrite.innerHTML = '"+n.replace(/(\r\n|\n|\r)/gm,"").replace(/\s{2,}/g," ").replace(/(\[br\])/gm,"")+"';h.appendChild(xjsCSSOverwrite);";i+=c}return""!==t&&r===!0&&(i+=t),item_1.Item.set("prop:BrowserJs",i,o)}).then(function(){return item_1.Item.set("prop:custom",JSON.stringify(a),o)}).then(function(){e?item_1.Item.set("refresh","",o).then(function(){i(this)}):i(this)})})},HTMLItem.prototype.isBrowserJSEnabled=function(){var t=this;return new Promise(function(e){var n=item_1.Item.attach(t._id);item_1.Item.get("prop:custom",n).then(function(t){var n=!0;try{var i=JSON.parse(t);i.hasOwnProperty("scriptEnabled")&&(n="true"==i.scriptEnabled)}catch(r){}e(n)})})},HTMLItem.prototype.enableBrowserJS=function(t){var e=this;return new Promise(function(n,i){var r=item_1.Item.attach(e._id),o={};item_1.Item.get("prop:custom",r).then(function(e){var n="",i="",a=" ",s=!0;try{o=JSON.parse(e),o.hasOwnProperty("cssEnabled")&&(s="true"==o.cssEnabled),o.hasOwnProperty("customJS")&&(n=o.customJS),o.hasOwnProperty("customCSS")&&(i=o.customCSS)}catch(u){}if(o.cssEnabled=s.toString(),o.scriptEnabled=t.toString(),o.customJS=n,o.customCSS=i,s===!0){var c='var xjsCSSOverwrite = document.createElement("style");xjsCSSOverwrite.id = "splitmedialabsCSSOverwrite";xjsCSSOverwrite.type = "text/css";var h = document.querySelector("head");var existing = document.querySelector("head #splitmedialabsCSSOverwrite");if (existing != null)h.removeChild(existing);xjsCSSOverwrite.innerHTML = "'+i.replace(/(\r\n|\n|\r)/gm,"").replace(/\s{2,}/g," ").replace(/(\[br\])/gm,"")+'";"h.appendChild(xjsCSSOverwrite);';a+=c}return""!==n&&t===!0&&(a+=n),item_1.Item.set("prop:BrowserJs",a,r)}).then(function(){return item_1.Item.set("prop:custom",JSON.stringify(o),r)}).then(function(){t?n(this):item_1.Item.set("refresh","",r).then(function(){n(this)})})})},HTMLItem.prototype.getCustomCSS=function(){var t=this;return new Promise(function(e){var n=item_1.Item.attach(t._id);item_1.Item.get("prop:custom",n).then(function(t){var n="";try{var i=JSON.parse(t);i.hasOwnProperty("customCSS")&&(n=i.customCSS)}catch(r){}e(n)})})},HTMLItem.prototype.setCustomCSS=function(t){var e=this;return new Promise(function(n,i){var r=item_1.Item.attach(e._id),o={};item_1.Item.get("prop:custom",r).then(function(e){var n="",i=" ",a=!0,s=!0;try{o=JSON.parse(e),o.hasOwnProperty("cssEnabled")&&(s="true"==o.cssEnabled),o.hasOwnProperty("scriptEnabled")&&(a="true"==o.scriptEnabled),o.hasOwnProperty("customJS")&&(n=o.customJS)}catch(u){}if(o.cssEnabled=s.toString(),o.scriptEnabled=a.toString(),o.customJS=n,o.customCSS=t,s===!0){var c='var xjsCSSOverwrite = document.createElement("style");xjsCSSOverwrite.id = "splitmedialabsCSSOverwrite";xjsCSSOverwrite.type = "text/css";var h = document.querySelector("head");var existing = document.querySelector("head #splitmedialabsCSSOverwrite");if (existing != null)h.removeChild(existing);xjsCSSOverwrite.innerHTML = "'+t.replace(/(\r\n|\n|\r)/gm,"").replace(/\s{2,}/g," ").replace(/(\[br\])/gm,"")+'";h.appendChild(xjsCSSOverwrite);';i+=c}return""!==n&&a===!0&&(i+=n),item_1.Item.set("prop:BrowserJs",i,r)}).then(function(){return item_1.Item.set("prop:custom",JSON.stringify(o),r)}).then(function(){n(this)})})},HTMLItem.prototype.isCustomCSSEnabled=function(){var t=this;return new Promise(function(e){var n=item_1.Item.attach(t._id);item_1.Item.get("prop:custom",n).then(function(t){var n=!0;try{var i=JSON.parse(t);i.hasOwnProperty("cssEnabled")&&(n="true"==i.cssEnabled)}catch(r){}e(n)})})},HTMLItem.prototype.enableCustomCSS=function(value){var _this=this;return new Promise(function(resolve,reject){var slot=item_1.Item.attach(_this._id),customObject={};item_1.Item.get("prop:custom",slot).then(function(t){var e="",n="",i=" ",r=!0;try{customObject=JSON.parse(t),customObject.hasOwnProperty("scriptEnabled")&&(r="true"==customObject.scriptEnabled),customObject.hasOwnProperty("customJS")&&(e=customObject.customJS),customObject.hasOwnProperty("customCSS")&&(n=customObject.customCSS)}catch(o){}if(customObject.scriptEnabled=r.toString(),customObject.cssEnabled=value.toString(),customObject.customJS=e,customObject.customCSS=n,value===!0){var a='var xjsCSSOverwrite = document.createElement("style");xjsCSSOverwrite.id = "splitmedialabsCSSOverwrite";xjsCSSOverwrite.type = "text/css";var h = document.querySelector("head");var existing = document.querySelector("head #splitmedialabsCSSOverwrite");if (existing != null)h.removeChild(existing);xjsCSSOverwrite.innerHTML = "'+n.replace(/(\r\n|\n|\r)/gm,"").replace(/\s{2,}/g," ").replace(/(\[br\])/gm,"")+'";h.appendChild(xjsCSSOverwrite);';i+=a}return""!==e&&value===r&&(i+=e),item_1.Item.set("prop:BrowserJs",i,slot)}).then(function(){return item_1.Item.set("prop:custom",JSON.stringify(customObject),slot)}).then(function(){if(value)resolve(this);else{var cssScript="var h = document.querySelector('head');var existing3 = document.querySelector('head #splitmedialabsCSSOverwrite');if (existing3 != null)h.removeChild(existing3);";environment_1.Environment.isSourcePlugin()?eval(cssScript):internal_1.exec("CallInner","eval",cssScript),resolve(this)}})})},HTMLItem.prototype.isBrowserTransparent=function(){var t=this;return new Promise(function(e){item_1.Item.attach(t._id);item_1.Item.get("prop:BrowserTransparent").then(function(t){e("1"===t)})})},HTMLItem.prototype.enableBrowserTransparency=function(t){var e=this;return new Promise(function(n){var i=item_1.Item.attach(e._id);item_1.Item.set("prop:BrowserTransparent",t?"1":"0",i).then(function(){n(e)})})},HTMLItem.prototype.getBrowserCustomSize=function(){var t=this;return new Promise(function(e){var n,i=item_1.Item.attach(t._id);item_1.Item.get("prop:BrowserSize",i).then(function(t){if(""!==t){var i=decodeURIComponent(t).split(","),r=i[0],o=i[1];n=rectangle_1.Rectangle.fromDimensions(Number(r),Number(o))}else n=rectangle_1.Rectangle.fromDimensions(0,0);e(n)})})},HTMLItem.prototype.setBrowserCustomSize=function(t){var e=this;return new Promise(function(n){var i=item_1.Item.attach(e._id);item_1.Item.set("prop:BrowserSize",t.toDimensionString(),i).then(function(){n(e)})})},HTMLItem}(item_2.Item);exports.HTMLItem=HTMLItem,mixin_1.applyMixins(HTMLItem,[ilayout_1.ItemLayout,icolor_1.ItemColor,ichroma_1.ItemChroma,itransition_1.ItemTransition,iconfig_1.ItemConfigurable])},{"../../internal/internal":20,"../../internal/item":21,"../../internal/util/mixin":23,"../../util/rectangle":34,"../environment":3,"./ichroma":9,"./icolor":10,"./iconfig":11,"./ilayout":12,"./item":13,"./itransition":14}],8:[function(t,e,n){var i=t("../../internal/item"),r=t("../environment"),o=function(){function t(){}return t.prototype.getVolume=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:volume",n).then(function(t){e(Number(t))})})},t.prototype.setVolume=function(t){var e=this;return new Promise(function(n,o){if(r.Environment.isSourcePlugin())o(Error("Source plugins cannot update audio source properties."));else{var a=i.Item.attach(e._id);t=0>t?0:t>100?100:t,i.Item.set("prop:volume",String(t),a).then(function(t){t?n(e):o(Error("Item set property failed"))})}})},t.prototype.isMute=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:mute",n).then(function(t){e("1"===t)})})},t.prototype.setMute=function(t){var e=this;return new Promise(function(n,o){if(r.Environment.isSourcePlugin())o(Error("Source plugins cannot update audio sources properties"));else{var a=i.Item.attach(e._id);i.Item.set("prop:mute",t?"1":"0",a).then(function(t){t?n(e):o(Error("Item set property failed"))})}})},t.prototype.getAudioOffset=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:AudioDelay",n).then(function(t){e(Number(t))})})},t.prototype.setAudioOffset=function(t){var e=this;return new Promise(function(n,o){if(r.Environment.isSourcePlugin())o(Error("Source plugins cannot update audio sources properties"));else{var a=i.Item.attach(e._id);i.Item.set("prop:AudioDelay",String(t),a).then(function(t){t?n(e):o(Error("Item set property failed"))})}})},t.prototype.isStreamOnlyEnabled=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:sounddev",n).then(function(t){e("1"===t)})})},t.prototype.setStreamOnlyEnabled=function(t){var e=this;return new Promise(function(n,o){if(r.Environment.isSourcePlugin())o(Error("Source plugins cannot update audio sources properties"));else{var a=i.Item.attach(e._id);i.Item.set("prop:sounddev",t?"1":"0",a).then(function(t){t?n(e):o(Error("Item set property failed"))})}})},t}();n.ItemAudio=o},{"../../internal/item":21,"../environment":3}],9:[function(t,e,n){var i=t("../../internal/item"),r=t("../../util/color");!function(t){t[t.LEGACY=0]="LEGACY",t[t.COLORKEY=1]="COLORKEY",t[t.RGBKEY=2]="RGBKEY"}(n.KeyingType||(n.KeyingType={}));n.KeyingType;!function(t){t[t.RED=0]="RED",t[t.GREEN=1]="GREEN",t[t.BLUE=2]="BLUE"}(n.ChromaPrimaryColors||(n.ChromaPrimaryColors={}));n.ChromaPrimaryColors;!function(t){t[t.NONE=0]="NONE",t[t.LOW=1]="LOW",t[t.HIGH=2]="HIGH"}(n.ChromaAntiAliasLevel||(n.ChromaAntiAliasLevel={}));var o=(n.ChromaAntiAliasLevel,function(){function t(){}return t.prototype.isChromaEnabled=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromakey",n).then(function(t){e("1"===t)})})},t.prototype.setChromaEnabled=function(t){var e=this;return new Promise(function(n,r){if("boolean"!=typeof t)r(TypeError("Parameter should be boolean."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromakey",t?"1":"0",o).then(function(){n(e)})}})},t.prototype.getKeyingType=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromakeytype",n).then(function(t){e(Number(t))})})},t.prototype.setKeyingType=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use a KeyingType value as the parameter."));else if(0>t||t>2)r(RangeError("Use a KeyingType value as the parameter."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromakeytype",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaAntiAliasLevel=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_antialiasing",n).then(function(t){e(Number(t))})})},t.prototype.setChromaAntiAliasLevel=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use a ChromaAntiAliasLevel value as the parameter."));else if(0>t||t>2)r(RangeError("Use a ChromaAntiAliasLevel value as the parameter."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_antialiasing",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaLegacyBrightness=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromabr",n).then(function(t){e(Number(t))})})},t.prototype.setChromaLegacyBrightness=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromabr",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaLegacySaturation=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromasat",n).then(function(t){e(Number(t))})})},t.prototype.setChromaLegacySaturation=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromasat",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaLegacyHue=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromahue",n).then(function(t){e(Number(t))})})},t.prototype.setChromaLegacyHue=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>180)r(RangeError("Valid value is an integer from 0-180."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromahue",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaLegacyThreshold=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromarang",n).then(function(t){e(Number(t))})})},t.prototype.setChromaLegacyThreshold=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromarang",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaLegacyAlphaSmoothing=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromaranga",n).then(function(t){e(Number(t))})})},t.prototype.setChromaLegacyAlphaSmoothing=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromaranga",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaRGBKeyPrimaryColor=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromargbkeyprimary",n).then(function(t){e(Number(t))})})},t.prototype.setChromaRGBKeyPrimaryColor=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use a ChromaPrimaryColors value as the parameter."));else if(0>t||t>2)r(RangeError("Use a ChromaPrimaryColors value as the parameter."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromargbkeyprimary",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaRGBKeyThreshold=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromargbkeythresh",n).then(function(t){e(Number(t))})})},t.prototype.setChromaRGBKeyThreshold=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromargbkeythresh",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaRGBKeyExposure=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_chromargbkeybalance",n).then(function(t){e(Number(t))})})},t.prototype.setChromaRGBKeyExposure=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_chromargbkeybalance",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaColorKeyThreshold=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_colorrang",n).then(function(t){e(Number(t))})})},t.prototype.setChromaColorKeyThreshold=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_colorrang",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaColorKeyExposure=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_colorranga",n).then(function(t){e(Number(t))})})},t.prototype.setChromaColorKeyExposure=function(t){var e=this;return new Promise(function(n,r){if("number"!=typeof t)r(TypeError("Use an integer as the parameter."));else if(0>t||t>255)r(RangeError("Valid value is an integer from 0-255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:key_colorranga",String(t),o).then(function(){n(e)})}})},t.prototype.getChromaColorKeyColor=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:key_colorrgb",n).then(function(t){var n=r.Color.fromBGRString(t);e(n)})})},t.prototype.setChromaColorKeyColor=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);i.Item.set("prop:key_colorrgb",String(t.getIbgr()),r).then(function(){n(e)})})},t;
}());n.ItemChroma=o},{"../../internal/item":21,"../../util/color":30}],10:[function(t,e,n){var i=t("../../internal/item"),r=t("../../util/color"),o=function(){function t(){}return t.prototype.getTransparency=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:alpha",n).then(function(t){e(Number(t))})})},t.prototype.setTransparency=function(t){var e=this;return new Promise(function(n,r){if(0>t||t>255)r(RangeError("Transparency may only be in the range 0 to 255."));else{var o=i.Item.attach(e._id);i.Item.set("prop:alpha",String(t),o).then(function(){n(e)})}})},t.prototype.getBrightness=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:cc_brightness",n).then(function(t){e(Number(t))})})},t.prototype.setBrightness=function(t){var e=this;return new Promise(function(n,r){if(-100>t||t>100)r(RangeError("Brightness may only be in the range -100 to 100."));else{var o=i.Item.attach(e._id);i.Item.set("prop:cc_brightness",String(t),o).then(function(){n(e)})}})},t.prototype.getContrast=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:cc_contrast",n).then(function(t){e(Number(t))})})},t.prototype.setContrast=function(t){var e=this;return new Promise(function(n,r){if(-100>t||t>100)r(RangeError("Contrast may only be in the range -100 to 100."));else{var o=i.Item.attach(e._id);i.Item.set("prop:cc_contrast",String(t),o).then(function(){n(e)})}})},t.prototype.getHue=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:cc_hue",n).then(function(t){e(Number(t))})})},t.prototype.setHue=function(t){var e=this;return new Promise(function(n,r){if(-180>t||t>180)r(RangeError("Contrast may only be in the range -180 to 180."));else{var o=i.Item.attach(e._id);i.Item.set("prop:cc_hue",String(t),o).then(function(){n(e)})}})},t.prototype.getSaturation=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:cc_saturation",n).then(function(t){e(Number(t))})})},t.prototype.setSaturation=function(t){var e=this;return new Promise(function(n,r){if(-100>t||t>100)r(RangeError("Saturation may only be in the range -100 to 100"));else{var o=i.Item.attach(e._id);i.Item.set("prop:cc_saturation",String(t),o).then(function(){n(e)})}})},t.prototype.getBorderColor=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:border",n).then(function(t){var n=Number(t)-2147483648,i=r.Color.fromBGRInt(n);e(i)})})},t.prototype.setBorderColor=function(t){var e=this;return new Promise(function(n,r){var o=i.Item.attach(e._id);i.Item.set("prop:border",String(t.getIbgr()-2147483648),o).then(function(){n(e)})})},t}();n.ItemColor=o},{"../../internal/item":21,"../../util/color":30}],11:[function(t,e,n){var i=t("../../internal/item"),r=t("../../internal/global"),o=t("../../internal/internal"),a=t("../environment"),s=function(){function t(){}return t.prototype.loadConfig=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:BrowserConfiguration",n).then(function(t){var n="null"===t?{}:JSON.parse(t),i=r.Global.getPersistentConfig();for(var o in i)delete n[o];e(n)})})},t.prototype.saveConfig=function(t){var e=this;return new Promise(function(n,s){if(a.Environment.isSourcePlugin){var u=i.Item.attach(e._id);if(0===u)if("[object Object]"==={}.toString.call(t)){var c=r.Global.getPersistentConfig();for(var p in c)t[p]=c[p];o.exec("SetBrowserProperty","Configuration",JSON.stringify(t)),n(e)}else s(Error("Configuration object should be in JSON format."));else s(Error("Sources may only request other sources to save a configuration. Consider calling requestSaveConfig() on this Item instance instead."))}else s(Error("Extensions and source configuration windows are not allowed to directly save configuration objects. Call requestSaveConfig() instead."))})},t.prototype.requestSaveConfig=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);o.exec("CallInner"+(0===r?"":r+1),"MessageSource",JSON.stringify({request:"saveConfig",data:t})),n(e)})},t.prototype.applyConfig=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);o.exec("CallInner"+(0===r?"":r+1),"MessageSource",JSON.stringify({request:"applyConfig",data:t})),n(e)})},t}();n.ItemConfigurable=s},{"../../internal/global":18,"../../internal/internal":20,"../../internal/item":21,"../environment":3}],12:[function(t,e,n){var i=t("../../internal/item"),r=t("../../util/rectangle"),o=function(){function t(){}return t.prototype.isKeepAspectRatio=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:keep_ar",n).then(function(t){e("1"===t)})})},t.prototype.setKeepAspectRatio=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);i.Item.set("prop:keep_ar",t?"1":"0",r).then(function(){n(e)})})},t.prototype.isPositionLocked=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:lockmove",n).then(function(t){e("1"===t)})})},t.prototype.setPositionLocked=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);i.Item.set("prop:lockmove",t?"1":"0",r).then(function(){n(e)})})},t.prototype.isEnhancedResizeEnabled=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:mipmaps",n).then(function(t){e("1"===t)})})},t.prototype.setEnhancedResizeEnabled=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);i.Item.set("prop:mipmaps",t?"1":"0",r).then(function(){n(e)})})},t.prototype.getPosition=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:pos",n).then(function(n){var i=decodeURIComponent(n).split(","),o=i[0],a=i[1],s=i[2],u=i[3];t.position=r.Rectangle.fromCoordinates(Number(a),Number(o),Number(s),Number(u)),e(t.position)})})},t.prototype.setPosition=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);e.position=t,i.Item.set("prop:pos",t.toCoordinateString(),r).then(function(){n(e)})})},t.prototype.getRotateY=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:rotate_y",n).then(function(t){e(Number(t))})})},t.prototype.setRotateY=function(t){var e=this;return new Promise(function(n,r){if(-360>t||t>360)r(Error("Invalid value. Min: -360, Max: 360"));else{var o=i.Item.attach(e._id);i.Item.set("prop:rotate_y",String(t),o).then(function(){n(e)})}})},t.prototype.getRotateX=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:rotate_x",n).then(function(t){e(Number(t))})})},t.prototype.setRotateX=function(t){var e=this;return new Promise(function(n,r){if(-360>t||t>360)r(Error("Invalid value. Min: -360, Max: 360"));else{var o=i.Item.attach(e._id);i.Item.set("prop:rotate_x",String(t),o).then(function(){n(e)})}})},t.prototype.getRotateZ=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:rotate_z",n).then(function(t){e(Number(t))})})},t.prototype.setRotateZ=function(t){var e=this;return new Promise(function(n,r){if(-360>t||t>360)r(Error("Invalid value. Min: -360, Max: 360"));else{var o=i.Item.attach(e._id);i.Item.set("prop:rotate_z",String(t),o).then(function(){n(e)})}})},t}();n.ItemLayout=o},{"../../internal/item":21,"../../util/rectangle":34}],13:[function(t,e,n){var i=t("../../internal/util/mixin"),r=t("../../internal/item"),o=t("../environment"),a=t("../../internal/util/json"),s=t("../../internal/util/xml"),u=t("../scene"),c=t("./ilayout");!function(t){t[t.UNDEFINED=0]="UNDEFINED",t[t.FILE=1]="FILE",t[t.LIVE=2]="LIVE",t[t.TEXT=3]="TEXT",t[t.BITMAP=4]="BITMAP",t[t.SCREEN=5]="SCREEN",t[t.FLASHFILE=6]="FLASHFILE",t[t.GAMESOURCE=7]="GAMESOURCE",t[t.HTML=8]="HTML"}(n.ItemTypes||(n.ItemTypes={}));var p=n.ItemTypes,m=function(){function t(t){t=t?t:{},this._name=t.name,this._cname=t.cname,this._id=t.id,this._sceneID=t.sceneID,this._value=t.value,this._keepLoaded=t.keeploaded,this._type=Number(t.type),this._xmlparams=t}return t.prototype.setName=function(t){var e=this;return new Promise(function(n){var i=r.Item.attach(e._id);e._name=t,r.Item.set("prop:name",e._name,i).then(function(){n(e)})})},t.prototype.getName=function(){var t=this;return new Promise(function(e){var n=r.Item.attach(t._id);r.Item.get("prop:name",n).then(function(n){t._name=n,e(n)})})},t.prototype.setCustomName=function(t){var e=this;return new Promise(function(n){var i=r.Item.attach(e._id);e._cname=t,r.Item.set("prop:cname",e._cname,i).then(function(){n(e)})})},t.prototype.getCustomName=function(){var t=this;return new Promise(function(e){var n=r.Item.attach(t._id);r.Item.get("prop:cname",n).then(function(n){t._cname=n,e(n)})})},t.prototype.getValue=function(){var t=this;return new Promise(function(e){var n=r.Item.attach(t._id);r.Item.get("prop:item",n).then(function(n){if(n="null"===n?"":n,""===n)t._value="",e(n);else try{t._value=s.XML.parseJSON(a.JSON.parse(n)),e(t._value)}catch(i){t._value=n,e(n)}})})},t.prototype.setValue=function(t){var e=this;return new Promise(function(n){var i=r.Item.attach(e._id),o="string"==typeof t?t:t.toString();"string"!=typeof t?e._value=a.JSON.parse(o):e._value=o,r.Item.set("prop:item",o,i).then(function(){n(e)})})},t.prototype.getKeepLoaded=function(){var t=this;return new Promise(function(e){var n=r.Item.attach(t._id);r.Item.get("prop:keeploaded",n).then(function(n){t._keepLoaded="1"===n,e(t._keepLoaded)})})},t.prototype.setKeepLoaded=function(t){var e=this;return new Promise(function(n){var i=r.Item.attach(e._id);e._keepLoaded=t,r.Item.set("prop:keeploaded",e._keepLoaded?"1":"0",i).then(function(){n(e)})})},t.prototype.getType=function(){var t=this;return new Promise(function(e){var n=r.Item.attach(t._id);r.Item.get("prop:type",n).then(function(n){t._type=p[p[Number(n)]],e(t._type)})})},t.prototype.getID=function(){var t=this;return new Promise(function(e){e(t._id)})},t.prototype.getSceneID=function(){var t=this;return new Promise(function(e){e(Number(t._sceneID)+1)})},t.prototype.toXML=function(){var t=new a.JSON;return t.tag="item",t.name=this._name,t.item=this._value,t.type=this._type,t.selfclosing=!0,this._cname&&(t.cname=this._cname),s.XML.parseJSON(t)},t.getCurrentSource=function(){return new Promise(function(t,e){o.Environment.isExtension()?e(Error("Extensions do not have sources associated with them.")):(o.Environment.isSourcePlugin()||o.Environment.isSourceConfig())&&u.Scene.searchAllForItemId(r.Item.getBaseID()).then(function(e){t(e)})})},t}();n.Item=m,i.applyMixins(m,[c.ItemLayout])},{"../../internal/item":21,"../../internal/util/json":22,"../../internal/util/mixin":23,"../../internal/util/xml":24,"../environment":3,"../scene":15,"./ilayout":12}],14:[function(t,e,n){var i=t("../../internal/item"),r=t("../transition"),o=function(){function t(){}return t.prototype.isVisible=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:visible",n).then(function(t){e("1"===t?!0:!1)})})},t.prototype.setVisible=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);i.Item.set("prop:visible",t?"1":"0",r).then(function(){n(e)})})},t.prototype.getTransition=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:transitionid",n).then(function(t){e(""===t?r.Transition.NONE:r.Transition[t.toUpperCase()])})})},t.prototype.setTransition=function(t){var e=this;return new Promise(function(n){var r=i.Item.attach(e._id);i.Item.set("prop:transitionid",t.toString(),r).then(function(){n(e)})})},t.prototype.getTransitionTime=function(){var t=this;return new Promise(function(e){var n=i.Item.attach(t._id);i.Item.get("prop:transitiontime",n).then(function(t){e(Number(t))})})},t.prototype.setTransitionTime=function(t){var e=this;return new Promise(function(n,r){if(0>t||t>6e4)r(RangeError("Transparency may only be in the range 0 to 60000."));else{var o=i.Item.attach(e._id);i.Item.set("prop:transitiontime",String(t),o).then(function(){n(e)})}})},t}();n.ItemTransition=o},{"../../internal/item":21,"../transition":16}],15:[function(t,e,n){var i=t("../internal/util/json"),r=t("../internal/util/xml"),o=t("../internal/app"),a=t("../internal/internal"),s=t("./environment"),u=t("./item/item"),c=t("./item/game"),p=t("./item/camera"),m=t("./item/audio"),l=t("./item/html"),h=function(){function t(t){this._id=t-1}return t._initializeScenePool=function(){if(0===t._scenePool.length)for(var e=0;e<t._maxScenes;e++)t._scenePool[e]=new t(e+1)},t.getById=function(e){return t._initializeScenePool(),t._scenePool[e-1]},t.getByName=function(e){t._initializeScenePool();var n=Promise.all(t._scenePool.map(function(n,i){return o.App.get("presetname:"+i).then(function(n){return e===n?t._scenePool[i]:null})}));return new Promise(function(t){n.then(function(e){for(var n=[],i=0;i<e.length;++i)null!==e[i]&&n.push(e[i]);t(n)})})},t.getActiveScene=function(){return new Promise(function(e){s.Environment.isSourcePlugin()?o.App.get("presetconfig:-1").then(function(n){var r=i.JSON.parse(n);if(!(r.children.length>0))throw new Error("presetconfig cannot fetch current scene");e(t.searchSceneWithItemId(r.children[0].id))}):o.App.get("preset:0").then(function(n){e(t.getById(Number(n)+1))})})},t.setActiveScene=function(e){return new Promise(function(n,i){s.Environment.isSourcePlugin()?i(Error("Not supported on source plugins")):e instanceof t?e.getID().then(function(t){o.App.set("preset",String(t)).then(function(t){n(t)})}):"number"==typeof e?1>e||e>12?i(Error("Invalid parameters. Valid range is 1 to 12.")):o.App.set("preset",String(e-1)).then(function(t){n(t)}):i(Error("Invalid parameters"))})},t.searchAllForItemId=function(e){var n=/^{[A-F0-9-]*}$/i.test(e);if(n)return t._initializeScenePool(),new Promise(function(n){var i=null,r=!1;t._scenePool.forEach(function(t,o,a){null===i&&t.getItems().then(function(t){r=t.some(function(t){return t._id===e?(i=t,!0):!1}),(r||Number(this)===a.length-1)&&n(i)}.bind(o))})});throw new Error("Not a valid ID format for items")},t.searchSceneWithItemId=function(e){var n=/^{[A-F0-9-]*}$/i.test(e);if(n)return t._initializeScenePool(),new Promise(function(n){var i=null,r=!1;t._scenePool.forEach(function(o,a,s){null===i&&o.getItems().then(function(o){r=o.some(function(n){return n._id===e?(i=t.getById(a+1),!0):!1}),(r||a===s.length-1)&&n(i)})})});throw new Error("Not a valid ID format for items")},t.searchAllForItemName=function(e){t._initializeScenePool();var n=[];return new Promise(function(i){return Promise.all(t._scenePool.map(function(t){return new Promise(function(i){t.getItems().then(function(t){return 0!==t.length?Promise.all(t.map(function(t){return new Promise(function(i){t.getName().then(function(i){return i.match(e)?(n.push(t),""):t.getValue()}).then(function(r){r.toString().match(e)&&n.push(t),i()})})})).then(function(){i()}):void i()})})})).then(function(){i(n)})})},t.initializeScenes=function(){return new Promise(function(t,e){s.Environment.isSourcePlugin()&&e(Error("function is not available for source")),o.App.get("presetcount").then(function(e){12!==Number(e)?o.App.set("presetconfig:11",'<placement name="Scene 12" defpos="0" />').then(function(e){t(e)}):t(!0)})})},t.prototype.getSceneNumber=function(){var t=this;return new Promise(function(e){e(t._id+1)})},t.prototype.getName=function(){var t=this;return new Promise(function(e){o.App.get("presetname:"+t._id).then(function(t){e(t)})})},t.prototype.setName=function(t){var e=this;return new Promise(function(n,i){s.Environment.isSourcePlugin()?i(Error("Scene names are readonly for source plugins.")):o.App.set("presetname:"+e._id,t).then(function(t){n(t)})})},t.prototype.getItems=function(){var t=this;return new Promise(function(e){o.App.getAsList("presetconfig:"+t._id).then(function(n){var i=[],r=function(t){return new Promise(function(e){var i=n[t],r=Number(i.type);e(r===u.ItemTypes.GAMESOURCE?new c.GameItem(i):r===u.ItemTypes.HTML?new l.HTMLItem(i):Number(n[t].type)===u.ItemTypes.LIVE&&-1===n[t].item.indexOf("{33D9A762-90C8-11D0-BD43-00A0C911CE86}")?new p.CameraItem(n[t]):Number(n[t].type)===u.ItemTypes.LIVE&&-1!==n[t].item.indexOf("{33D9A762-90C8-11D0-BD43-00A0C911CE86}")?new m.AudioItem(n[t]):new u.Item(n[t]))})};if(Array.isArray(n))for(var o=0;o<n.length;o++)n[o].sceneID=t._id,i.push(r(o));Promise.all(i).then(function(t){e(t)})})})},t.prototype.isEmpty=function(){var t=this;return new Promise(function(e){o.App.get("presetisempty:"+t._id).then(function(t){e("1"===t)})})},t.prototype.setItemOrder=function(e){var n=this;return new Promise(function(c,p){if(s.Environment.isSourcePlugin())p(Error("not available for source plugins"));else{e.reverse();var m=[];t.getActiveScene().then(function(t){return e.every(function(t){return t instanceof u.Item})?new Promise(function(i){var r=[];for(var o in e)r.push(function(t){return new Promise(function(i){e[t].getID().then(function(e){m[t]=e,i(n)})})}(o));Promise.all(r).then(function(){return t.getSceneNumber()}).then(function(t){i(t)})}):(m=e,t.getSceneNumber())}).then(function(t){if(Number(t)-1===n._id&&s.Environment.isSourceConfig())a.exec("SourcesListOrderSave",m.join(",")),c(n);else{var e;n.getName().then(function(t){return e=t,o.App.getAsList("presetconfig:"+n._id)}).then(function(t){var a=new i.JSON;if(a.children=[],a.tag="placement",a.name=e,Array.isArray(t)){for(var s=["name","cname","item"],u=0;u<t.length;u++){for(var l=0;l<s.length;l++)t[u][s[l]]=t[u][s[l]].replace(/([^\\])(\\)([^\\])/g,"$1\\\\$3"),t[u][s[l]]=t[u][s[l]].replace(/"/g,"&quot;");a.children[m.indexOf(t[u].id)]=t[u]}o.App.set("presetconfig:"+n._id,r.XML.parseJSON(a).toString()).then(function(){c(n)})}else p(Error("Scene does not have any items"))})}})}})},t._maxScenes=12,t._scenePool=[],t}();n.Scene=h},{"../internal/app":17,"../internal/internal":20,"../internal/util/json":22,"../internal/util/xml":24,"./environment":3,"./item/audio":4,"./item/camera":5,"./item/game":6,"./item/html":7,"./item/item":13}],16:[function(t,e,n){var i=function(){function t(e){this._key=e,this._value=t._transitionMap[e]}return t.prototype.toString=function(){return this._value},t.prototype.toTransitionKey=function(){return this._key},t._transitionMap={NONE:"",CLOCK:"clock",COLLAPSE:"collapse",FADE:"fade",FAN:"fan",HOLE:"hole",MOVE_BOTTOM:"move_bottom",MOVE_LEFT:"move_left",MOVE_LEFT_RIGHT:"move_left_right",MOVE_RIGHT:"move_right",MOVE_TOP:"move_top",MOVE_TOP_BOTTOM:"move_top_bottom",WAVE:"wave"},t.NONE=new t("NONE"),t.CLOCK=new t("CLOCK"),t.COLLAPSE=new t("COLLAPSE"),t.FADE=new t("FADE"),t.FAN=new t("FAN"),t.HOLE=new t("HOLE"),t.MOVE_BOTTOM=new t("MOVE_BOTTOM"),t.MOVE_LEFT=new t("MOVE_LEFT"),t.MOVE_LEFT_RIGHT=new t("MOVE_LEFT_RIGHT"),t.MOVE_RIGHT=new t("MOVE_RIGHT"),t.MOVE_TOP=new t("MOVE_TOP"),t.MOVE_TOP_BOTTOM=new t("MOVE_TOP_BOTTOM"),t.WAVE=new t("WAVE"),t}();n.Transition=i},{}],17:[function(t,e,n){var i=t("./internal"),r=t("./util/json"),o=function(){function t(){}return t.get=function(t){return new Promise(function(e){i.exec("AppGetPropertyAsync",t,e)})},t.set=function(t,e){return new Promise(function(n){i.exec("AppSetPropertyAsync",t,e,function(t){n(Number(t)<0?!1:!0)})})},t.getAsList=function(e){return new Promise(function(n){t.get(e).then(function(t){var e=r.JSON.parse(t),i=[];e.children&&e.children.length>0&&(i=e.children),n(i)})})},t.getGlobalProperty=function(t){return i.exec("GetGlobalProperty",t)},t.callDll=function(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];var r=[].slice.call(arguments);return r.unshift("CallDll"),i.exec.apply(this,r)},t.callFunc=function(t,e){return new Promise(function(n){i.exec("AppCallFuncAsync",t,e,function(t){n(t)})})},t.postMessage=function(t){for(var e=this,n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r];return new Promise(function(r){n.unshift(t),n.unshift("PostMessageToParent"),n.push(function(t){r(t)}),i.exec.apply(e,n)})},t}();n.App=o},{"./internal":20,"./util/json":22}],18:[function(t,e,n){var i=function(){function t(){}return t.addInitializationPromise=function(e){t.initialPromises.push(e)},t.getInitializationPromises=function(){return t.initialPromises},t.setPersistentConfig=function(e){t.persistedConfig=e},t.getPersistentConfig=function(){return t.persistedConfig},t.persistedConfig={},t.initialPromises=[],t}();n.Global=i},{}],19:[function(t,e,n){function i(t,e){if("http://"===t.substring(0,7)||"https://"===t.substring(0,8))return t;if("//"===t.substring(0,2))return e.split("://")[0]+":"+t;if("../"===t.substring(0,3)){for(var n=0;"../"===t.substring(0,3);)t=t.substring(3),++n;var i=e.split("/");return i=i.slice(0,length-1-n),i.push(t),i.join("/")}"./"===t.substring(0,2)&&(t=t.substring(2));var r=e.split("/");return r[r.length-1]=t,r.join("/")}function r(){return new Promise(function(t){if(u.Environment.isSourcePlugin()){var e={};try{var n=p.exec("GetConfiguration");e=JSON.parse(n)}catch(r){}finally{for(var o=document.getElementsByTagName("meta"),a=o.length-1;a>=0;a--)if("xsplit:config-url"===o[a].name){var s=i(o[a].content,window.location.href);e.configUrl=s;var c={configUrl:s};m.Global.setPersistentConfig(c);break}p.exec("SetBrowserProperty","Configuration",JSON.stringify(e)),t()}}else t()})}function o(){return new Promise(function(t){u.Environment.isSourcePlugin()||u.Environment.isSourceConfig()?p.exec("GetLocalPropertyAsync","prop:id",function(e){var n=decodeURIComponent(e);c.Item.setBaseID(n),u.Environment.isSourcePlugin()&&c.Item.lockSourceSlot(n),t()}):t()})}function a(){return new Promise(function(t){u.Environment.isSourceConfig()?window.addEventListener("load",function(){l.SourceConfigWindow.getInstance().emit("config-load"),t()}):t()})}function s(){m.Global.addInitializationPromise(r()),m.Global.addInitializationPromise(o()),m.Global.addInitializationPromise(a()),Promise.all(m.Global.getInitializationPromises()).then(function(){document.dispatchEvent(new CustomEvent("xsplit-js-ready",{bubbles:!0}))})}var u=t("../core/environment"),c=t("./item"),p=t("./internal"),m=t("./global"),l=t("../window/config");s()},{"../core/environment":3,"../window/config":35,"./global":18,"./internal":20,"./item":21}],20:[function(t,e,n){function i(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];var o=null,a=!1;return e.length>0&&(o=e[e.length-1],o instanceof Function?e.pop():o=null),n.DEBUG&&console.log(['internal.exec("',t,'") ',JSON.stringify(e)].join(" ")),window.external&&window.external[t]&&window.external[t]instanceof Function&&(a=window.external[t].apply(this,e)),null!==o&&(r[a]=o),a}n.DEBUG=!1;var r={};n.exec=i,window.OnAsyncCallback=function(t,e){var n=r[t];n instanceof Function&&n.call(this,decodeURIComponent(e))}},{}],21:[function(t,e,n){var i=t("./internal"),r=t("../core/environment"),o=function(){function t(){}return t.attach=function(e){var n=t.itemSlotMap.indexOf(e);return-1===n&&(n=++t.lastSlot%t.MAX_SLOTS,t.islockedSourceSlot&&0===n&&++n,t.lastSlot=n,t.itemSlotMap[n]=e,r.Environment.isExtension()?i.exec("SearchVideoItem"+("0"===String(n)?"":n+1),e):i.exec("AttachVideoItem"+("0"===String(n)?"":n+1),e)),n},t.lockSourceSlot=function(e){void 0!==e?(t.islockedSourceSlot=!0,t.itemSlotMap[0]=e):(t.islockedSourceSlot=!1,t.itemSlotMap[0]="")},t.get=function(t,e){return void 0===e&&(e=0),new Promise(function(n){i.exec("GetLocalPropertyAsync"+("0"===String(e)?"":e+1),t,function(t){n(t)})})},t.set=function(t,e,n){return void 0===n&&(n=0),new Promise(function(r){i.exec("SetLocalPropertyAsync"+("0"===String(n)?"":n+1),t,e,function(t){r(!(Number(t)<0))})})},t.callFunc=function(t,e){i.exec("CallInner",t,e)},t.setBaseID=function(e){t.baseID=e},t.getBaseID=function(){return t.baseID},t.MAX_SLOTS=2,t.lastSlot=t.MAX_SLOTS-1,t.itemSlotMap=[],t.islockedSourceSlot=!1,t}();n.Item=o},{"../core/environment":3,"./internal":20}],22:[function(t,e,n){var i=t("./xml"),r=function(){function t(e){if(void 0!==e&&""!==e){var n=e;e instanceof i.XML&&(n=e.toString());var r=/<([^\s>\/]+)/g,o=/(\/>)/g,a=r.exec(n),s=o.exec(n),u=(new DOMParser).parseFromString(n,"application/xml");if(u.getElementsByTagName("parsererror").length>0)throw new Error("XML parsing error. Invalid XML string");var c=function(e){var i=new t;i.tag=e.tagName,a=r.exec(n),null===a&&0===o.lastIndex||(null===a&&o.lastIndex>0?(i.selfclosing=!0,s=o.exec(n)):null!==a&&o.lastIndex>r.lastIndex||null!==a&&o.lastIndex<r.lastIndex&&o.lastIndex===r.lastIndex-a[0].length&&(i.selfclosing=!0,s=o.exec(n)));for(var u=0;u<e.attributes.length;u++){var p=e.attributes[u];i[p.name]=p.value}i.children=[];for(var m=0;m<e.childNodes.length;m++){var l=e.childNodes[m];l instanceof Element&&i.children.push(c(l))}return void 0===i.value&&0===i.children.length&&(delete i.children,i.value=e.textContent),i};return c(u.childNodes[0])}}return t.parse=function(e){return new t(e)},t}();n.JSON=r},{"./xml":24}],23:[function(t,e,n){function i(t,e){e.forEach(function(e){Object.getOwnPropertyNames(e.prototype).forEach(function(n){"constructor"!==n&&(t.prototype[n]=e.prototype[n])})})}n.applyMixins=i},{}],24:[function(t,e,n){var i=function(){function t(e){var n="",i="";void 0===e.value&&(e.value="");for(var r in e)t.RESERVED_ATTRIBUTES.test(r)||void 0===e[r]||(n+=[" ",r,'="',e[r],'"'].join(""));void 0===e.children&&(e.children=[]);for(var o=0,a=e.children;o<a.length;o++){var s=a[o];e.value+=new t(s).toString()}e.selfclosing===!0?this.xml=["<",e.tag,n,"/>"].join(""):""!==i?this.xml=["<",e.tag,n,">",i,"</",e.tag,">"].join(""):this.xml=["<",e.tag,n,">",e.value,"</",e.tag,">"].join("")}return t.prototype.toString=function(){return this.xml},t.parseJSON=function(e){return new t(e)},t.encode=function(t){return t.replace(/[&<>'']/g,function(t){return"&"+{"&":"amp","<":"lt",">":"gt","'":"quot",'"':"#39"}[t]+";"})},t.RESERVED_ATTRIBUTES=/^(children|tag|value|selfclosing)$/i,t}();n.XML=i},{}],25:[function(t,e,n){var i=t("../internal/util/json"),r=t("../internal/util/xml"),o=function(){function t(t){this._defaultConsole=!1,this._defaultMultimedia=!1,this._defaultCommunication=!1,t=t||{},this._id=t.id,this._name=t.name,this._adapter=t.adapter,this._adapterdev=t.adapterdev,this._dSoundGuid=t.dSoundGuid,this._dataFlow=t.dataFlow,this._state=t.state,this._defaultConsole=t.defaultConsole,this._defaultMultimedia=t.defaultMultimedia,this._defaultCommunication=t.defaultCommunication,this._level=void 0!==t.level?t.level:1,this._enable=void 0!==t.enable?t.enable:!0,this._hwlevel=void 0!==t.hwlevel?t.hwlevel:-1,this._hwenable=void 0!==t.hwenable?t.hwenable:255,this._delay=void 0!==t.delay?t.delay:0,this._mix=void 0!==t.mix?t.mix:0}return t.prototype.getId=function(){return this._id},t.prototype.getName=function(){return this._name},t.prototype.getDataFlow=function(){return this._dataFlow},t.prototype.isDefaultDevice=function(){return this._defaultConsole&&this._defaultMultimedia},t.prototype.getLevel=function(){return this._level},t.prototype.setLevel=function(t){return this._level=t,this},t.prototype.isEnabled=function(){return this._enable},t.prototype.setEnabled=function(t){return this._enable=t,this},t.prototype.getSystemLevel=function(){return this._hwlevel},t.prototype.setSystemLevel=function(t){return this._hwlevel=t,this},t.prototype.getSystemEnabled=function(){return this._hwenable},t.prototype.setSystemEnabled=function(t){return this._hwenable=t,this},t.prototype.getDelay=function(){return this._delay},t.prototype.setDelay=function(t){return this._delay=t,this},t.prototype.toString=function(){var t=new i.JSON;return t.tag="dev",t.selfclosing=!0,t.id=this.getId(),t.level=this.getLevel().toFixed(6),t.enable=this.isEnabled()?1:0,t.hwlevel=this.getSystemLevel().toFixed(6),t.hwenable=this.getSystemEnabled(),t.delay=this.getDelay(),t.mix=this._mix,r.XML.parseJSON(t).toString()},t.parse=function(e){var n=new t({id:e.id,name:e.name,adapter:e.adapter,adapterdev:e.adapterdev,dataFlow:e.DataFlow,state:e.State,dSoundGuid:e.DSoundGuid,defaultCommunication:"1"===e.DefaultCommunication,defaultConsole:"1"===e.DefaultConsole,defaultMultimedia:"1"===e.DefaultMultimedia});return n.setLevel(Number(void 0!==e.level?e.level:1)).setEnabled(void 0!==e.enable?"1"===e.enable:!0).setSystemLevel(Number(void 0!==e.hwlevel?e.hwlevel:-1)).setSystemEnabled(void 0!==e.hwenable?e.hwenable:255).setDelay(Number(void 0!==e.delay?e.delay:0)),n},t.STATE_ACTIVE="Active",t.DATAFLOW_RENDER="Render",t.DATAFLOW_CAPTURE="Capture",t.SYSTEM_LEVEL_MUTE=0,t.SYSTEM_LEVEL_ENABLE=1,t.SYSTEM_MUTE_CHANGE_NOT_ALLOWED=255,t}();n.AudioDevice=o},{"../internal/util/json":22,"../internal/util/xml":24}],26:[function(t,e,n){var i=t("../internal/util/json"),r=t("../internal/util/xml"),o=t("../internal/app"),a=function(){function t(t){this._id=t.id,this._name=t.name}return t.prototype.getId=function(){return this._id},t.prototype.getName=function(){return this._name},t.prototype.toXML=function(){var t=new i.JSON;return t.disp=this._id,t.name=this._name,r.XML.parseJSON(t)},t.parse=function(e){var n=new t({id:e.disp,name:e.name});return n},t.prototype.addToScene=function(){var t=this;return new Promise(function(e){o.App.callFunc("addcamera","dev:"+t._id).then(function(){e(!0)})})},t}();n.CameraDevice=a},{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24}],27:[function(t,e,n){var i=t("../util/rectangle"),r=t("../internal/util/json"),o=t("../internal/util/xml"),a=t("../internal/app"),s=function(){function t(){}return t.prototype.getPid=function(){return this._pid},t.prototype.getHandle=function(){return this._handle},t.prototype.getWindowHandle=function(){return this._hwnd},t.prototype.getGapiType=function(){return this._gapitype},t.prototype.getResolution=function(){return i.Rectangle.fromDimensions(this._width,this._height)},t.prototype.isFullscreen=function(){return 1===this._flags?!0:!1},t.prototype.getWindowName=function(){return this._wndname},t.prototype.getLastFrameTimestamp=function(){return this._lastframets},t.prototype.getFpsRender=function(){return this._fpsRender},t.prototype.getFpsCapture=function(){return this._fpsCapture},t.prototype.getImageName=function(){return this._imagename},t.prototype.getReplace=function(){return this._replace},t.parse=function(e){var n=new t;return n._pid=void 0!==e.pid?parseInt(e.pid):void 0,n._handle=void 0!==e.handle?parseInt(e.handle):void 0,n._hwnd=void 0!==e.hwnd?parseInt(e.hwnd):void 0,n._gapitype=e.GapiType,n._width=void 0!==e.width?parseInt(e.width):void 0,n._height=void 0!==e.height?parseInt(e.height):void 0,n._flags=void 0!==e.flags?parseInt(e.flags):void 0,n._wndname=e.wndname,n._lastframets=void 0!==e.lastframets?parseInt(e.lastframets):void 0,n._fpsRender=void 0!==e.fpsRender?Number(e.fpsRender):void 0,n._fpsCapture=void 0!==e.fpsCapture?Number(e.fpsCapture):void 0,n._imagename=e.imagename,n._replace=e.replace,n},t.prototype.toXML=function(){var t=new r.JSON;return t.tag="src",t.pid=this._pid,t.handle=this._handle,t.hwnd=this._hwnd,t.gapitype=this._gapitype,t.width=this._width,t.height=this._height,t.flags=this._flags,t.wndname=this._wndname,t.lastframets=this._lastframets,t.selfclosing=!0,o.XML.parseJSON(t)},t.prototype.addToScene=function(){var t=this;return new Promise(function(e){a.App.callFunc("addgamesource","dev:"+t.toXML()).then(function(){e(!0)})})},t}();n.Game=s},{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24,"../util/rectangle":34}],28:[function(t,e,n){var i=t("../internal/util/json"),r=t("../internal/util/xml"),o=t("../internal/app"),a=function(){function t(){}return t.parse=function(e){var n=new t;return n._disp=e.disp,n._name=e.name,n},t.prototype.toXML=function(){var t=new i.JSON;return t.tag="item",t.item=this._disp,t.name=this._name,t.type="2",t.selfclosing=!0,r.XML.parseJSON(t)},t.prototype.addToScene=function(){var t=this;return new Promise(function(e){o.App.callFunc("additem",t.toXML().toString()).then(function(){e(!0)})})},t}();n.MicrophoneDevice=a},{"../internal/app":17,"../internal/util/json":22,"../internal/util/xml":24}],29:[function(t,e,n){
var i=t("../internal/app"),r=t("./audio"),o=t("./microphone"),a=t("./camera"),s=t("./game"),u=t("../core/environment"),c=t("../internal/internal");!function(t){t[t.RENDER=1]="RENDER",t[t.CAPTURE=2]="CAPTURE",t[t.ALL=3]="ALL"}(n.AudioDeviceDataflow||(n.AudioDeviceDataflow={}));var p=n.AudioDeviceDataflow;!function(t){t[t.ACTIVE=1]="ACTIVE",t[t.DISABLED=2]="DISABLED",t[t.UNPLUGGED=4]="UNPLUGGED",t[t.NOTPRESENT=8]="NOTPRESENT",t[t.ALL=15]="ALL"}(n.AudioDeviceState||(n.AudioDeviceState={}));var m=n.AudioDeviceState,l=function(){function t(){}return t.getAudioDevices=function(t,e){return void 0===t&&(t=p.ALL),void 0===e&&(e=m.ACTIVE),new Promise(function(n){i.App.getAsList("wasapienum").then(function(i){var o=[];if(void 0!==i)for(var a=i.length,s=0;a>s;++s){var u=i[s],c=m[String(u.State).toUpperCase().replace(/\s+/g,"")];if((c&e)===c){var l=p[String(u.DataFlow).toUpperCase()];(l&t)===l&&(u.name.toLowerCase().indexOf("xsplit")>-1||o.push(r.AudioDevice.parse(u)))}}n(o)})})},t.getCameraDevices=function(){return new Promise(function(t){i.App.getAsList("dshowenum:vsrc").then(function(e){var n=[];if(void 0!==e){for(var i=0;i<e.length;i++){var r=e[i];-1===String(r.disp).toLowerCase().indexOf("xsplit")&&String(r.disp).toLowerCase()!=="@DEVICE:SW:{860BB310-5D01-11D0-BD3B-00A0C911CE86}\\{778abfb2-e87b-48a2-8d33-675150fcf8a2}".toLowerCase()&&n.push(a.CameraDevice.parse(r))}t(n)}})})},t.getGames=function(){return new Promise(function(t){i.App.getAsList("gsenum").then(function(e){var n=[];if(void 0!==e)for(var i=e.length,r=0;i>r;++r)n.push(s.Game.parse(e[r]));t(n)})})},t.getMicrophones=function(){return new Promise(function(t){i.App.getAsList("dshowenum:asrc").then(function(e){var n=[];if(void 0!==e)for(var i=e.length,r=0;i>r;++r)n.push(o.MicrophoneDevice.parse(e[r]));t(n)})})},t.getCursorPosition=function(){return new Promise(function(t,e){if(u.Environment.isSourcePlugin())e(Error("function is not available for source"));else{var n=c.exec("GetCursorPos");if("string"==typeof n){var i=n.split(","),r={};r.x=Number(i[0]),r.y=Number(i[1]),t(r)}else e(Error("cannot fetch current cursor position"))}})},t.setCursorPosition=function(t){return new Promise(function(e,n){u.Environment.isSourcePlugin()?n(Error("function is not available for source")):"number"!=typeof t.x||"number"!=typeof t.y?n(Error("invalid parameters")):(c.exec("SetCursorPos",String(t.x),String(t.y)),e(!0))})},t}();n.System=l},{"../core/environment":3,"../internal/app":17,"../internal/internal":20,"./audio":25,"./camera":26,"./game":27,"./microphone":28}],30:[function(t,e,n){var i=function(){function t(t){if(void 0!==t.rgb)this.setRgb(t.rgb);else if(void 0!==t.irgb)this.setIrgb(t.irgb);else if(void 0!==t.bgr)this.setBgr(t.bgr);else{if(void 0===t.ibgr)throw new Error("Do not call Color constructor without parameters.");this.setIbgr(t.ibgr)}}return t.fromRGBString=function(e){return new t({rgb:e})},t.fromRGBInt=function(e){return new t({irgb:e})},t.fromBGRString=function(e){return new t({bgr:e})},t.fromBGRInt=function(e){return new t({ibgr:e})},t.prototype.getRgb=function(){return this._rgb},t.prototype.setRgb=function(t){return this._rgb=t.replace(/^#/,""),this._irgb=parseInt(this._rgb,16),this._bgr=[this._rgb.substring(4,6),this._rgb.substring(2,4),this._rgb.substring(0,2)].join(""),this._ibgr=parseInt(this._bgr,16),this},t.prototype.getBgr=function(){return this._bgr},t.prototype.setBgr=function(t){return this.setRgb([t.substring(4,6),t.substring(2,4),t.substring(0,2)].join("")),this},t.prototype.getIrgb=function(){return this._irgb},t.prototype.setIrgb=function(t){for(var e=t.toString(16);e.length<6;)e="0"+e;return this.setRgb(e),this},t.prototype.getIbgr=function(){return this._ibgr},t.prototype.setIbgr=function(t){for(var e=t.toString(16);e.length<6;)e="0"+e;return this.setBgr(e),this},t}();n.Color=i},{}],31:[function(t,e,n){var i=function(){function t(){this._handlers={}}return t.prototype.on=function(t,e){void 0===this._handlers[t]&&(this._handlers[t]=[]),this._handlers[t].push(e)},t.prototype.emit=function(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];if(void 0!==this._handlers[t])for(var i=0,r=this._handlers[t];i<r.length;i++){var o=r[i];o.apply(this,e)}},t}();n.EventEmitter=i},{}],32:[function(t,e,n){var i=t("../internal/internal"),r=function(){function t(){}return t.getFileContent=function(t){return new Promise(function(e){e(i.exec("GetFileContent",t))})},t.getWebContent=function(t){return new Promise(function(e){i.exec("GetWebContent",t,function(t){e(t)})})},t.openUrl=function(t){i.exec("OpenUrl",t)},t.openFileDialog=function(e,n){return new Promise(function(r,o){var a=0;void 0!==e&&null!==e&&(e.allowMultiSelect===!0&&(a|=t._ALLOW_MULTI_SELECT),e.fileMustExist===!0&&(a|=t._FILE_MUST_EXIST),e.forceShowHidden===!0&&(a|=t._FORCE_SHOW_HIDDEN));var s="";void 0!==n&&null!==n&&void 0!==n.name&&void 0!==n.extensions&&(s=n.name+"|",s+=n.extensions.map(function(t){return"*."+t}).join(";"),s+="||"),i.exec("OpenFileDialogAsync",null,null,String(a),s,function(t){"null"!==t?r(t.split("|")):o(Error("File selection cancelled."))})})},t._ALLOW_MULTI_SELECT=512,t._FILE_MUST_EXIST=4096,t._FORCE_SHOW_HIDDEN=268435456,t}();n.IO=r},{"../internal/internal":20}],33:[function(t,e,n){function i(){return a}function r(){o=!0}var o=!1,a=new Promise(function(t){document.addEventListener("xsplit-js-ready",function(){t()}),o&&t()});n.ready=i,n.setReady=r},{}],34:[function(t,e,n){var i=function(){function t(){}return t.prototype.getTop=function(){return this._top},t.prototype.setTop=function(t){return this._top=t,void 0!==this._bottom&&this._height!==this._top-this._bottom?this.setHeight(Math.abs(this._top-this._bottom)):void 0!==this._height&&this._bottom!==this._top+this._height&&this.setBottom(this._top+this._height),this},t.prototype.getLeft=function(){return this._left},t.prototype.setLeft=function(t){return this._left=t,void 0!==this._right&&this._width!==Math.abs(this._right-this._left)?this.setWidth(Math.abs(this._right-this._left)):void 0!==this._width&&this._height!==this._left+this._width&&this.setRight(this._left+this._width),this},t.prototype.getRight=function(){return this._right},t.prototype.setRight=function(t){return this._right=t,void 0!==this._left&&this._width!==Math.abs(this._right-this._left)?this.setWidth(Math.abs(this._right-this._left)):void 0!==this._width&&this._left!==this._right-this._width&&this.setLeft(this._right-this._width),this},t.prototype.getBottom=function(){return this._bottom},t.prototype.setBottom=function(t){return this._bottom=t,void 0!==this._top&&this._height!==Math.abs(this._top-this._bottom)?this.setHeight(Math.abs(this._top-this._bottom)):void 0!==this._height&&this._top!==this._bottom-this._height&&this.setTop(this._bottom-this._height),this},t.prototype.getWidth=function(){return this._width},t.prototype.setWidth=function(t){return this._width=t,void 0!==this._right&&this._left!==this._right-this._width?this.setLeft(this._right-this._width):void 0!==this._left&&this._right!==this._left+this._width&&this.setRight(this._left+this._width),this},t.prototype.getHeight=function(){return this._height},t.prototype.setHeight=function(t){return this._height=t,void 0!==this._top&&this._bottom!==this._top+this._height?this.setBottom(this._top+this._height):void 0!==this._bottom&&this._top!==this._bottom-this._height&&this.setTop(this._bottom-this._height),this},t.fromDimensions=function(e,n){if(0>e||0>n)throw new Error("Rectangle dimensions cannot be negative.");var i=new t;return i._width=e,i._height=n,i},t.fromCoordinates=function(e,n,i,r){if(e>r)throw new Error("Top coordinate must be smaller than bottom.");if(n>i)throw new Error("Right coordinate must be smaller than left.");var o=new t;return o._top=e,o._left=n,o.setRight(i),o.setBottom(r),o},t.prototype.toDimensionString=function(){return this._width+","+this._height},t.prototype.toCoordinateString=function(){if(void 0===this._left)throw new Error("This Rectangle instance does not have coordinates.");return this._left+","+this._top+","+this._right+","+this._bottom},t.prototype.toString=function(t){if(void 0===t)return this.toDimensionString();var e=t;return e=e.replace(":left",String(this._left)),e=e.replace(":top",String(this._top)),e=e.replace(":right",String(this._right)),e=e.replace(":bottom",String(this._bottom)),e=e.replace(":width",String(this._width)),e=e.replace(":height",String(this._height))},t}();n.Rectangle=i},{}],35:[function(t,e,n){var i=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},r=t("../util/eventemitter"),o=t("../internal/internal"),a=function(t){function e(){var n=this;t.call(this),window.addEventListener("message",function(t){try{var e=JSON.parse(t.data)}catch(n){return}switch(e.event){case"set-selected-tab":this.emit(e.event,e.value);break;case"async-callback":this.emit(e.event,{asyncId:e.value.asyncId,result:e.value.result})}}.bind(this)),this.on("config-load",function(){n._informConfigLoaded()}),e._instance=this}return i(e,t),e.getInstance=function(){return void 0===e._instance&&(e._instance=new e),e._instance},e.prototype._notify=function(t){window.parent.postMessage(JSON.stringify(t),"*")},e.prototype.useFullWindow=function(){this._setRenderMode(e._MODE_FULL),this.resizeConfig(354,390)},e.prototype.useTabbedWindow=function(t){this._setRenderMode(e._MODE_TABBED),this._declareCustomTabs(t.customTabs),this._setTabOrder(t.tabOrder)},e.prototype._setRenderMode=function(t){this._mode=t,this._notify({event:"set-mode",value:t})},e.prototype._setTabOrder=function(t){this._notify({event:"set-tab-order",value:JSON.stringify(t)})},e.prototype._declareCustomTabs=function(t){this._notify({event:"set-custom-tabs",value:JSON.stringify(t)})},e.prototype._informConfigLoaded=function(){this._notify({event:"load"})},e.prototype.resizeConfig=function(t,e){this._notify({event:"resize",value:JSON.stringify({width:t,height:e})})},e.prototype.closeConfig=function(){o.exec("Close")},e._MODE_FULL="full",e._MODE_TABBED="embedded",e}(r.EventEmitter);n.SourceConfigWindow=a},{"../internal/internal":20,"../util/eventemitter":31}],36:[function(t,e,n){var i=t("../util/rectangle"),r=t("../core/environment"),o=t("../internal/internal"),a=function(){function t(){if(r.Environment.isSourcePlugin())throw new Error("Dialogs are not available for source plugins.");return this}return t.createDialog=function(e){var n=new t;return n._url=e,n},t.createAutoDialog=function(e){var n=new t;return n._url=e,n._autoclose=!0,n},t["return"]=function(t){void 0!==t&&o.exec("SetDialogResult",t),o.exec("Close")},t.prototype.setSize=function(t,e){return void 0===t&&(t=300),void 0===e&&(e=300),this._size=i.Rectangle.fromDimensions(t,e),this},t.prototype.setTitle=function(t){if(this._autoclose)throw new Error("Autoclosing dialogs cannot use this method.");return this._title=t,this},t.prototype.setBorderOptions=function(t,e){if(void 0===t&&(t=!1),void 0===e&&(e=!1),this._autoclose)throw new Error("Autoclosing dialogs cannot use this method.");return this._showBorder=t,this._resizable=e,this},t.prototype.setButtons=function(t,e){if(void 0===t&&(t=!1),void 0===e&&(e=!1),this._autoclose)throw new Error("Autoclosing dialogs cannot use this method.");return this._minimize=t,this._maximize=e,this},t.prototype.show=function(){return this._autoclose?o.exec("NewAutoDialog",this._url,"",void 0===this._size?void 0:this._size.getWidth()+","+this._size.getHeight()):o.exec("NewDialog",this._url,"",void 0===this._size?void 0:this._size.getWidth()+","+this._size.getHeight(),this._calculateFlags(),this._title),this},t.prototype.getResult=function(){return new Promise(function(t){var e=function(n){n.target.removeEventListener(n.type,e),t(n.detail)};document.addEventListener("xsplit-dialog-result",e)})},t.prototype.close=function(){o.exec("CloseDialog")},t.prototype._calculateFlags=function(){var t=0;return this._showBorder&&(t+=1),this._resizable&&(t+=4),this._minimize&&(t+=8),this._maximize&&(t+=16),(this._title||this._minimize||this._maximize)&&(t+=2),String(t)},t}();n.Dialog=a,(r.Environment.isSourceConfig()||r.Environment.isExtension())&&(window.OnDialogResult=function(t){document.dispatchEvent(new CustomEvent("xsplit-dialog-result",{detail:t}))})},{"../core/environment":3,"../internal/internal":20,"../util/rectangle":34}],37:[function(t,e,n){var i=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},r=t("../core/environment"),o=t("../util/eventemitter"),a=t("../internal/app"),s="2",u=function(t){function e(){t.call(this),e._instance=this}return i(e,t),e.getInstance=function(){return void 0===e._instance&&(e._instance=new e),e._instance},e.prototype.resize=function(t,e){a.App.postMessage(s,String(t),String(e))},e}(o.EventEmitter);n.ExtensionWindow=u,r.Environment.isExtension()&&(window.OnSceneLoad=function(t,e){0===Number(t)&&u.getInstance().emit("scene-load",Number(e))})},{"../core/environment":3,"../internal/app":17,"../util/eventemitter":31}],38:[function(t,e,n){var i=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},r=t("../core/environment"),o=t("../util/eventemitter"),a=function(t){function e(){t.call(this),this.on("message-source",function(t){void 0!==t.request&&("saveConfig"===t.request?this.emit("save-config",t.data):"applyConfig"===t.request&&this.emit("apply-config",t.data))}),e._instance=this}return i(e,t),e.getInstance=function(){return void 0===e._instance&&(e._instance=new e),e._instance},e}(o.EventEmitter);n.SourcePluginWindow=a,r.Environment.isSourcePlugin()&&(window.MessageSource=function(t){a.getInstance().emit("message-source",JSON.parse(t))},window.SetConfiguration=function(t){try{var e=JSON.parse(t),n=a.getInstance();n.emit("apply-config",e),n.emit("save-config",e)}catch(i){return}},window.setBackGroundColor=function(t){a.getInstance().emit("set-background-color",t)})},{"../core/environment":3,"../util/eventemitter":31}],xjs:[function(t,e,n){function i(t){for(var e in t)n.hasOwnProperty(e)||(n[e]=t[e])}t("./internal/init"),i(t("./util/color")),i(t("./util/rectangle")),i(t("./util/io")),i(t("./core/environment")),i(t("./core/app")),i(t("./core/channel")),i(t("./core/scene")),i(t("./core/transition")),i(t("./core/item/item")),i(t("./core/item/camera")),i(t("./core/item/game")),i(t("./core/item/audio")),i(t("./core/item/html"));var r=t("./core/item/ichroma");n.KeyingType=r.KeyingType,n.ChromaPrimaryColors=r.ChromaPrimaryColors,n.ChromaAntiAliasLevel=r.ChromaAntiAliasLevel,i(t("./system/system")),i(t("./system/audio")),i(t("./system/game")),i(t("./system/camera")),i(t("./system/microphone")),i(t("./window/config")),i(t("./window/source")),i(t("./window/extension")),i(t("./window/dialog"));var o=t("./util/ready");n.ready=o.ready},{"./core/app":1,"./core/channel":2,"./core/environment":3,"./core/item/audio":4,"./core/item/camera":5,"./core/item/game":6,"./core/item/html":7,"./core/item/ichroma":9,"./core/item/item":13,"./core/scene":15,"./core/transition":16,"./internal/init":19,"./system/audio":25,"./system/camera":26,"./system/game":27,"./system/microphone":28,"./system/system":29,"./util/color":30,"./util/io":32,"./util/ready":33,"./util/rectangle":34,"./window/config":35,"./window/dialog":36,"./window/extension":37,"./window/source":38}]},{},["xjs"]);
!function(){"use strict";var e=require("xjs");("undefined"==typeof ignore_xjs||0==ignore_xjs)&&e.ready().then(function(){e.Scene.getActiveScene().then(function(n){n.getItems().then(function(n){for(var t in n){var i=n[t];i instanceof e.HTMLItem&&!function(n){n.getURL().then(function(t){if(t.indexOf("strexm")>=0){var i=e.Rectangle.fromDimensions(1920,1080);n.setBrowserCustomSize(i);var i=e.Rectangle.fromCoordinates(0,0,1,1);n.setPosition(i)}})}(i)}})})})}();
(function($,window,document,undefined){"use strict";var pluginName='countDown';var defaults={css_class:'countdown',always_show_days:false,with_labels:true,with_seconds:true,with_hours:true,with_separators:true,label_dd:'days',label_hh:'hours',label_mm:'minutes',label_ss:'seconds',separator:':',separator_days:','};function CountDown(element,options){this.element=$(element);this.options=$.extend({},defaults,options);this._defaults=defaults;this._name=pluginName;this.init();}
...
this.markup();this.setTimeoutDelay=this.sToMs(1);this.daysVisible=true;this.timeElement.bind('time.elapsed',this.options.onTimeElapsed);this.doCountDown();},parseEndDate:function(str){var d;d=this.parseDuration(str);if(d instanceof Date){return d;}
...
if(!this.options.with_hours){this.timeElement.find('.item-hh').remove();this.timeElement.find('.separator:nth-child(3)').remove();}
...
this.displayRemainingTime({'ss':ss<10?'0'+ss.toString():ss.toString(),'mm':mm<10?'0'+mm.toString():mm.toString(),'hh':hh<10?'0'+hh.toString():hh.toString(),'dd':dd.toString()});if(!this.options.with_seconds&&dd===0&&mm===0&&hh===0){ss=0;}
if(dd===0&&mm===0&&hh===0&&ss===0){return this.timeElement.trigger('time.elapsed');}
var self=this;window.setTimeout(function(){self.doCountDown();},self.setTimeoutDelay);},displayRemainingTime:function(remaining){var attr=[];attr.push('P');if(remaining.dd!=='0'){attr.push(remaining.dd,'D');}
attr.push('T',remaining.hh,'H',remaining.mm,'M');if(this.options.with_seconds){attr.push(remaining.ss,'S');}
this.timeElement.attr('datetime',attr.join(''));if(this.daysVisible&&!this.options.always_show_days&&remaining.dd==='0'){this.item_dd.remove();this.separator_dd.remove();this.daysVisible=false;}
this.remaining_dd.text(remaining.dd);this.remaining_hh1.text(remaining.hh[0]);this.remaining_hh2.text(remaining.hh[1]);this.remaining_mm1.text(remaining.mm[0]);this.remaining_mm2.text(remaining.mm[1]);this.remaining_ss1.text(remaining.ss[0]);this.remaining_ss2.text(remaining.ss[1]);}});$.fn[pluginName]=function(options){var args=arguments;if(options===undefined||typeof options==='object'){return this.each(function(){if(!$.data(this,'plugin_'+pluginName)){$.data(this,'plugin_'+pluginName,new CountDown(this,options));}});}
else if(typeof options==='string'&&options[0]!=='_'&&options!=='init'){var returns;this.each(function(){var instance=$.data(this,'plugin_'+pluginName);if(instance instanceof CountDown&&typeof instance[options]==='function'){returns=instance[options].apply(instance,Array.prototype.slice.call(args,1));}
